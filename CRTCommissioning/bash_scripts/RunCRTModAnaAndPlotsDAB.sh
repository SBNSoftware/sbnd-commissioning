...
#PDF will open when finished running, or can be found in /sbnd/data/users/$USER/crtModTests/
#=========================================================================
...
#Uncomment this section to run analyzer modules for all given runs, even if a local copy already exists on the daq machine
	    echo 'Running analyzer modules run ${run}';
	    ssh $USER@sbnd-daq00.fnal.gov "
		source /home/nfs/sbnd/run_BernCRTAna.sh ${run};"
	fi
#============
